                        ...
                        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center items-center lg:items-start">
                            {material.map((item, index) => (
                                ...
                                >
                                    ...
                                    <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-gray">
                                        <a href="#" className="text-gray-500 dark:text-gray-900">
                                            {item.title}
                                        </a>
                                    </h2>
